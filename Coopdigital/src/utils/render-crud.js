...
// `fields` puede ser un array fijo, o una función (sync o async) que
// devuelve el array de campos — útil cuando el formulario necesita datos
// en vivo (por ejemplo, un select con la lista actual de asociados).
